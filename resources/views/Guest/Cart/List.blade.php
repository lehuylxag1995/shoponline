        ...
        <div class="row">
            ...
            <div class="col-lg-10 col-xl-7 m-lr-auto m-b-50">
                <div class="m-l-25 m-r--38 m-lr-0-xl">
                    <form action="{{ route('Update.Cart.Session') }}" method="post" enctype="multipart/form-data">
                        @csrf
                            ...
                            <table class="table-shopping-cart">
                                <tbody>
                                    ...
                                    @forelse ($ListProduct as $product)
                                        @php
                                            $priceTotal = $Cart[$product->id] * $product->price;
                                        ...
                                        <tr class="table_row">
                                            ...
                                            <td class="column-4">
                                                <div class="wrap-num-product flex-w m-l-auto m-r-0">
                                                    ...
                                                    <input class="mtext-104 cl3 txt-center num-product" min="1"
                                                        type="number" name="quantity[]" value="{{ $Cart[$product->id] }}">
                                                    <div class="btn-num-product-up cl8 hov-btn3 trans-04 flex-c-m">
                                                        <i class="fs-16 zmdi zmdi-plus"></i>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="column-5">{{ number_format($priceTotal) }}</td>
                                            <td class="p-r-50">
                                                <a href="/gio-hang/remove/{{ $product->id }}">Xoá</a>
                                            </td>
                                        </tr>
                        ...
                        <div class="flex-w flex-t bor12 p-t-15 p-b-30">
                            ...
                            <div class="size-209 p-r-18 p-r-0-sm w-full-ssm">
                                <div class="p-t-15">
                                    ...
                                    <div class="bor8 bg0 m-b-12">
                                        <textarea class="stext-111 cl8 plh3 size-111 p-lr-15" name="note" id="" placeholder="Ghi chú"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
